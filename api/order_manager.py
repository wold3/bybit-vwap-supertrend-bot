...
class OrderManager:
    ...
    def place_market_order(self, symbol, side, qty, leverage=1):
        ...
        try:
            ...
            if not order_id:
                logger.error(f"Order failed response: {resp}")
                return None
    ...
    def check_order_status(self, order_id):
        ...
        try:
            elapsed = (datetime.utcnow() - order["created_at"]).seconds
            ...
            logger.error(f"check_order_status error: {e}")
            return None
